...
export const DEFAULT_POSTERS: ShowcaseItem[] = [
  {
    ...
    imageUrl: '/brand/poster-hthss-hd.png',
...
export const DEFAULT_PILLARS: ShowcaseItem[] = [
  ...
  },
  {
    ...
    value: 'Tinggalkan cara manual yang rumit. Kami mengimplementasikan sistem manajemen event semi-digital yang terintegrasi. Proses pendaftaran, rekapitulasi database peserta yang otomatis, penyusunan start list, hingga distribusi hasil perlombaan diproses secara cepat, rapi, dan mudah diakses oleh seluruh pihak yang berkepentingan.',
    orderNo: 3,
    isActive: true,
  },
  {
